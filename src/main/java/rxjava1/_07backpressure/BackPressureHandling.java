package rxjava1._07backpressure;

import rx.Observable;

/*
 * TODO 60 Suppose the consumer cannot keep up with the producer, what can you do?
...
public class BackPressureHandling {
	...
	public static void main (String args[]) throws InterruptedException {
		...
		/*
		 * TODO 62 Did you get an exception? A MissingBackpressureException? Great! Do you know why? 
		 * 
		 * (spoiler alert ! ;-))
		 ...
		 * 
		 * We saw an interesting feature in 03async that can help us, so let's make sure f1 & f2 run in separate threads (simultaneously) 
		...
		/*
		 * TODO 64 Our MissingBackpressureException is back in town ... how inconvenient!
		...
		/*
		 * TODO 61 Let's take a look at the zipWith operator : 
