package rxjava1._05transforming.solution;
...
/*
 * TOODO 40 Transforming Observables with Operators
...
public class MyRXJava {
	...
	public static void main(String args[]) {
		...
		/*
		 * TOODO 41 : Create an Observable from the fruit list
		 */
		...
		/*
		 * TOODO 43 : concatenate both Observables and print out.
		 */
		...
		/*
		 * TOODO 44 : only interested until the color starts with a "y", then stop.
		 */
